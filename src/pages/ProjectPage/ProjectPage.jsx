...
import ImgFour from "../../assets/projectPage/Placeholder 4.png";
import ImgFive from "../../assets/projectPage/Placeholder 5.png";
      ...
      <div className="flex gap-10 lg:gap- 5 md:flex-row flex-col md:flex-wrap md:full  justify-center items-center pb-[3em] ">
        ...
        <div className="bg-surfacePrimary p-[1.3em] pb-[2em] rounded-xl hover:border hover:border-secondaryBrand project-card hover:cursor-pointer  w-[90%] md:w-fit">
          ...
          >
            ...
            {projectTwo && (
              <div className="absolute top-[4em] right-1 transform -translate-y-1/2 project-icon z-30 flex flex-col gap-1">
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://github.com/Thatgirl9/Foodie-app"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                ...
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://food-ie-app.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img
          ...
          <div className="mt-2 font-sectionTypo">
            ...
            <p className="w-[33ch] md:w-[35ch] text-textPrimary mt-3 text-base">
              A mobile web application that allows users to order home-cooked
              food.
            </p>
          </div>
        </div>
        ...
        <div className="bg-surfacePrimary p-[1.3em] pb-[2em] rounded-xl hover:border hover:border-secondaryBrand project-card hover:cursor-pointer w-[90%] md:w-fit ">
          <div
            className="project-img  overflow-hidden relative"
            onMouseEnter={() => setProjectThree(true)}
            onMouseLeave={() => setProjectThree(false)}
          >
            <img
              src={ImgFour}
              alt="Pricing UI Project Image"
              className="w-[20em]"
            />
            ...
            {projectThree && (
              <div className="absolute top-[4em] right-1 transform -translate-y-1/2 project-icon z-30 flex flex-col gap-1">
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://github.com/Thatgirl9/Pricing-UI"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                ...
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://pricing-ui-g.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img
          ...
          >
            ...
            {projectFour && (
              <div className="absolute top-[4em] right-1 transform -translate-y-1/2 project-icon z-30 flex flex-col gap-1">
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://github.com/Thatgirl9/Fylo-Landing-Page"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                ...
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://fylo-page-35d601.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img
        ...
        <div className="bg-surfacePrimary p-[1.3em] pb-[2em] rounded-xl hover:border hover:border-secondaryBrand project-card hover:cursor-pointer  w-[90%] md:w-fit">
          <div
            className="project-img  overflow-hidden relative"
            onMouseEnter={() => setProjectFive(true)}
            onMouseLeave={() => setProjectFive(false)}
          >
            <img
              src={ImgTwo}
              alt="Podcast Project Image"
        ...
        <div className="bg-surfacePrimary p-[1.3em] pb-[2em] rounded-xl hover:border hover:border-secondaryBrand project-card hover:cursor-pointer w-[90%] md:w-fit ">
          <div
            className="project-img  overflow-hidden relative"
            onMouseEnter={() => setProjectSix(true)}
            onMouseLeave={() => setProjectSix(false)}
          >
            <img
              src={ImgThree}
            ...
            {projectSix && (
              <div className="absolute top-[4em] right-1 transform -translate-y-1/2 project-icon z-30 flex flex-col gap-1">
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://github.com/Thatgirl9/Html-Form-X-"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <svg
                ...
                <button className="bg-surfaceSecondary p-1 rounded-md border border-transparent hover:border-secondaryBrand">
                  <a
                    href="https://beamish-moxie-cff982.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <img
          ...
          <div className="mt-2 font-sectionTypo">
            <div className="flex justify-between">
              <p className="text-textSecondary text-sm">April 2023</p>
              <p className="flex gap-3">
                <img src={Html} alt="Html Logo" className="w-[20px] h-[20px]" />
                <img src={Css} alt="CSS Logo" className="w-[20px] h-[20px]" />
              </p>
